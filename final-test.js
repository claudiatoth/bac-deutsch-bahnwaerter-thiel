// ============================================
// SELBSTTEST — Bahnwärter Thiel (BAC germană maternă)
...
const finalTestData = [
    // 📖 Werk (3)
    { type: 'multiple', category: '📖 Werk', question: 'Zu welcher Epoche gehört „Bahnwärter Thiel"?', options: ['Romantik', 'Naturalismus', 'Expressionismus', 'Klassik'], correct: 'Naturalismus', explanation: 'Hauptmann ist Hauptvertreter des Naturalismus (mit impressionistischen Zügen).' },
    { type: 'multiple', category: '📖 Werk', question: 'Welcher Gattung gehört das Werk an?', options: ['Roman', 'Novelle', 'Drama', 'Ballade'], correct: 'Novelle', explanation: 'Eine Novelle — Untertitel: „novellistische Studie".' },
    { type: 'luckentext', category: '📖 Werk', question: 'Ergänze den Familiennamen des Autors:', sentence: 'Der Autor heißt Gerhart <strong>______</strong>.', translation: '1862–1946, Nobelpreis 1912', accept: ['hauptmann'], correct: 'Hauptmann', explanation: 'Gerhart Hauptmann (1862–1946).' },

    // 👥 Figuren (3)
    { type: 'multiple', category: '👥 Figuren', question: 'Wer ist der Protagonist?', options: ['Tobias', 'Thiel', 'Gideon', 'Botho'], correct: 'Thiel', explanation: 'Der Bahnwärter Thiel — herkulisch, fromm, am Ende wahnsinnig.' },
    { type: 'luckentext', category: '👥 Figuren', question: 'Ergänze den Namen:', sentence: 'Thiels erste, vergeistigte Frau heißt <strong>______</strong>.', translation: 'moare la nașterea lui Tobias', accept: ['minna'], correct: 'Minna', explanation: 'Minna — nach ihrem Tod idealisierte Lichtgestalt (Totenkult).' },
    { type: 'multiple', category: '👥 Figuren', question: 'Was verkörpert die Figur Lene?', options: ['Geist und Seele', 'Trieb, Körper und Naturgewalt', 'Reichtum und Adel', 'Bildung'], correct: 'Trieb, Körper und Naturgewalt', explanation: 'Lene (Kuhmagd) ist das sinnliche, brutale Gegenbild zur vergeistigten Minna.' },

    // 🎯 Themen & Symbole (3)
    { type: 'multiple', category: '🎯 Themen', question: 'Was ist der zentrale Konflikt?', options: ['Arm gegen Reich', 'Pflicht gegen Trieb', 'Stadt gegen Land', 'Glaube gegen Wissenschaft'], correct: 'Pflicht gegen Trieb', explanation: 'Thiels Spaltung zwischen der geistigen Minna und der triebhaften Lene.' },
    { type: 'multiple', category: '🎭 Symbole', question: 'Was symbolisiert die Eisenbahn / „die Maschine"?', options: ['Wohlstand', 'Technik, Schicksal und zerstörerische Gewalt', 'die Liebe', 'die Religion'], correct: 'Technik, Schicksal und zerstörerische Gewalt', explanation: 'Die Maschine zerreißt die Naturidylle („Glotzaugen", „Blutregen") und tötet Tobias.' },
    { type: 'luckentext', category: '🎭 Symbole', question: 'Ergänze die tödliche Maschine:', sentence: 'Der kleine Tobias wird vom <strong>______</strong> überfahren und stirbt.', translation: 'mașina / trenul', accept: ['zug', 'der zug', 'eisenbahn', 'die eisenbahn'], correct: 'Zug', explanation: 'Der Zug (die Maschine) tötet Tobias — die Technik bringt Unheil.' },

    // 🏗️ Aufbau (2)
    { type: 'multiple', category: '🏗️ Aufbau', question: 'Welche Erzählform hat die Novelle?', options: ['Ich-Erzähler', 'Er-Erzähler (auktorial)', 'Briefroman', 'reiner Dialog'], correct: 'Er-Erzähler (auktorial)', explanation: 'Er-Erzähler mit naturalistischem Detail + impressionistischen Stimmungsbildern.' },
    { type: 'multiple', category: '🏗️ Aufbau', question: 'Warum gilt das Werk als „Übergangswerk"?', options: ['weil es ein Drama ist', 'weil es Naturalismus mit Impressionismus und Symbolismus verbindet', 'weil es im Mittelalter spielt', 'weil es ein Märchen ist'], correct: 'weil es Naturalismus mit Impressionismus und Symbolismus verbindet', explanation: 'Stimmungsbilder, Symbole und das Unbewusste gehen über den reinen Naturalismus hinaus.' },

    // 💡 Deutung (2)
    { type: 'luckentext', category: '💡 Deutung', question: 'Ergänze (Determinismus):', sentence: 'Thiel ist Mörder, aber durch Trieb, Milieu und Krankheit zugleich ein <strong>______</strong>.', translation: 'victimă', accept: ['opfer', 'das opfer'], correct: 'Opfer', explanation: 'Täter UND Opfer — der Determinismus relativiert seine Schuld.' },
    { type: 'multiple', category: '💡 Deutung', question: 'Wie endet die Novelle?', options: ['Thiel versöhnt sich mit Lene', 'Thiel wird wahnsinnig, tötet Lene und das Kind und kommt in die Anstalt', 'Thiel zieht in die Stadt', 'Tobias überlebt'], correct: 'Thiel wird wahnsinnig, tötet Lene und das Kind und kommt in die Anstalt', explanation: 'Nach Tobias’ Tod bricht Thiels Spaltung als Wahnsinn auf — kein versöhnlicher Schluss.' },
...
function buildFinalTest() {
    ...
    container.innerHTML = `
        <div id="test-intro" class="test-intro">
            ...
            <p>Selbsttest mit <strong>${finalTestData.length} Fragen</strong> über <em>Bahnwärter Thiel</em> (Werk, Figuren, Themen, Symbole, Aufbau, Deutung, Schreiben).</p>
